package com.example.RuiyuHuang_project1
...
import com.example.RuiyuHuang_project1.SQLiteHelper
import com.example.RuiyuHuang_project1.R
...
class MainActivity : AppCompatActivity() {
    ...
    private val videoUri: Uri by lazy {
        ...
        Uri.parse("android.resource://com.example.RuiyuHuang_project1/" + R.raw.heartrate)
    }
    //val videoUri = Uri.parse("android.resource://com.example.RuiyuHuang_project1/" + R.raw.hr)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        respButton.setOnClickListener {
            val inputCSVfile = resources.openRawResource(R.raw.breathe)
